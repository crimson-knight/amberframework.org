...
must be re-proven for every release. The active beta.5 evidence and remaining
gates are tracked in `RELEASE_PROOF_BETA5.md`; `RELEASE_PROOF_BETA4.md` and
`RELEASE_PROOF.md` are historical release records.
